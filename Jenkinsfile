    ...
    stages {
        stage('Git checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/UCHE2022/devops-fully-automated-infra.git'
                sh 'ls'
            }
        }
     ...
     post { 
        always { 
            ...
            slackSend channel: '#uche-jenkins-cicd-pipeline-alerts', color: COLOR_MAP[currentBuild.currentResult], message: "*${currentBuild.currentResult}:* Job ${env.JOB_NAME} build ${env.BUILD_NUMBER} \n More info at: ${env.BUILD_URL}"
        }
    }

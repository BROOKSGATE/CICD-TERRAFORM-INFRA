    ...
    stages {
        stage('Git checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/BROOKSGATE/CICD-TERRAFORM-INFRA.git'
                sh 'ls'
            }
        }
     ...
     post { 
        always { 
            ...
            slackSend channel: '#jenkins-channel', color: COLOR_MAP[currentBuild.currentResult], message: "*${currentBuild.currentResult}:* Job ${env.JOB_NAME} build ${env.BUILD_NUMBER} \n More info at: ${env.BUILD_URL}"
        }
    }
